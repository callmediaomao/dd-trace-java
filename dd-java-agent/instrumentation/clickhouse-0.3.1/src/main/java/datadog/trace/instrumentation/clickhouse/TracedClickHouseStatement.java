...
public class TracedClickHouseStatement implements ClickHouseStatement {
    ...
    public TracedClickHouseStatement(ClickHouseStatement delegate, DBInfo connectionInfo) {
...
//        return ClickHouseStatementTracingWrapper.of(connectionInfo, "executeBatch",
